...
@Injectable()
export class PopMovieService{
  constructor(private http: HttpClient) {}

  search(){
    return this.http.get('https://hw8-backend-310009.wl.r.appspot.com/popularmovie');
  }
}
...
@Component({
  ...
  providers: [PopMovieService]
})

export class PopularMoviesComponent implements OnInit {
  constructor(private service: PopMovieService) {}
  movies = [];
  moviesFormatted = [];
  mobile = false;
  ngOnInit() {
